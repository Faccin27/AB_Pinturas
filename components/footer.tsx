        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-white/80 mb-4">
              Serviços de qualidade em pintura residencial, comercial e montagem de móveis.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#início" className="text-white/80 hover:text-white transition-colors">
                  Início
                </Link>
              </li>
              <li>
                <Link href="#serviços" className="text-white/80 hover:text-white transition-colors">
                  Serviços
                </Link>
              </li>
              <li>
      ...
      <div className="border-t border-white/10">
        <div className="container py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white/80 text-sm">
            © {new Date().getFullYear()} AB Pinturas e Serviços. Todos os direitos reservados.
          </p>

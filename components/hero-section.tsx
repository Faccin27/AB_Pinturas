        ...
        <div className="max-w-4xl mx-auto text-center text-white space-y-8">
          ...
          <div className="pt-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              {[
                { icon: Paintbrush, title: "Pintura em Geral", desc: "Residencial e comercial" },
                { icon: Wrench, title: "Pequenos Reparos", desc: "Manutenção geral" },
                { icon: Package, title: "Montagem de Móveis", desc: "Montagem e desmontagem" },
              ].map((service, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center shadow-lg hover:scale-105 transition-all duration-200">
